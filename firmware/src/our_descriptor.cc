...
const uint8_t our_report_descriptor_spacemouse_pro[] = {
    0x05, 0x01,       // Usage Page (Generic Desktop Ctrls)
...
const our_descriptor_def_t our_descriptors[] = {
    ...
    {
        .idx = 6,
        .descriptor = our_report_descriptor_spacemouse_pro,
        .descriptor_length = sizeof(our_report_descriptor_spacemouse_pro),
        .vid = 0x046D, // 0x046D
        .pid = 0xC62b, // 0xC62b
        .handle_received_report = do_handle_received_report,
    },
